...
backgroundImg = loadImage("download (5).png");
}
...
function setup() {
 ...
 block3 = new Block(800, 300, 20 ,30);
  //block18 = new Block(860, 305, 20, 30);
  //block3.addImage(blockImg);

 block4 = new Block(830, 300, 20 ,30);
  //block4.addImage(blockImg);

  block5 = new Block(860, 300, 20, 30);
 ...
 // block11.addImage(blockImg);
  ...
  block13 = new Block(800, 220, 20, 30);
  block14 = new Block(830, 220, 20, 30);
  block15 = new Block(860, 220, 20, 30);
  block16 = new Block(890, 220, 20, 30);
  block17 = new Block(920, 220, 20, 30);
...
function draw() {
  ...
  if(backgroundImg)
    ...
    noStroke();
        ...
        textSize(25)
        fill("Red")
        text("Score : " + score, width-350, 30); 

        textFont("Impact");
        textSize(25);
        noStroke();
        fill("red");
        text("Press the space key to re-attatch the doctor to the sling",width - 1100, 30);
